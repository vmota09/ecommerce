...
<!-- jQuery sticky menu -->
<script src="/ecommerce2/res/site/js/owl.carousel.min.js"></script>
<script src="/ecommerce2/res/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/ecommerce2/res/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/ecommerce2/res/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/ecommerce2/res/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="/ecommerce2/res/site/js/script.slider.js"></script>
</body>
</html>